...
test('hasClerkRedirectCallback detects Clerk OAuth callback and handshake parameters', () => {
	...
	assert.equal(hasClerkRedirectCallback('https://tick.example.com/?__clerk_handshake=abc'), true);
	assert.equal(hasClerkRedirectCallback('https://tick.example.com/?__clerk_synced=true'), true);
